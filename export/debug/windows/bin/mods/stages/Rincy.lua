...
function onCreate()
	...
	makeAnimatedLuaSprite('bg0', path..'RincyLayer0', xOffset+350, yOffset-80);
	addAnimationByPrefix('bg0','RincyLayer0','RincyLayer0',48,true);
	setScrollFactor('bg0', .5, .5);
	...
	makeAnimatedLuaSprite('guest4', path..'/RincyGuest/'..'RincyGuest4', -650, 310);
	...
	makeAnimatedLuaSprite('guest5', path..'/RincyGuest/'..'RincyGuest5', 770, 280);
